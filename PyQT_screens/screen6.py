...
class startWindow(QMainWindow):
    ...
    #     # Set a gradient background for the overlay
    #     self.overlay.setStyleSheet("""
    #         background: qlineargradient(
    #             spread:pad, x1:0, y1:0, x2:0, y2:1,
    #             stop:0 rgba(135, 206, 235, 255), 
    ...
    #     """)
    #     self.start_button.setFixedSize(250, 60)
    #     self.start_button.setGeometry(screen_size.width() // 2 - 125, screen_size.height() // 2 - 30, 250, 60)
    #     self.start_button.setCursor(Qt.CursorShape.PointingHandCursor)
    #     self.start_button.clicked.connect(self.navigate_next.emit)
    ...
    #     """)
    #     self.prev_button.setFixedSize(250, 60)
    #     self.prev_button.setGeometry(screen_size.width() // 2 - 125, screen_size.height() // 2 + 40, 250, 60)
    #     self.prev_button.setCursor(Qt.CursorShape.PointingHandCursor)
    #     self.prev_button.clicked.connect(self.navigate_prev.emit)
