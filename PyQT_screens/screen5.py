...
# #     navigate_next = pyqtSignal()  # Custom signal for navigation to the next screen

# #     def __init__(self, panda_image_path):
# #         super().__init__()
...
# #         self.create_slider(slider_layout, "Start Contrast")
# #         slider_layout.addSpacerItem(QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed))
# #         self.create_slider(slider_layout, "Spatial Frequency")
...
# #     def create_slider(self, layout, label_text):
...
# #     window = SetValuesWindow3(panda_image_path)
# #     window.show()
...
# #     def __init__(self, panda_image_path, experiment_type, test_type, eye_tracker_type):
# #         super().__init__()
...
# #     def create_slider(self, layout, label_text, min_value=0, max_value=1000, start_value=0, step=1):
# #         label = QLabel(label_text, self)
# #         label.setAlignment(Qt.AlignmentFlag.AlignCenter)
# #         label.setStyleSheet("font-size: 24px; font-weight: bold; color: #008682;")
# #         layout.addWidget(label)
...
# #                 self.create_slider(self.slider_layout, "Min Contrast", 0, 1000, 20, 1)
# #                 self.slider_layout.addSpacerItem(QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed))
# #                 self.create_slider(self.slider_layout, "Max Contrast", 0, 1000, 1000, 1)
# #                 self.slider_layout.addSpacerItem(QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed))
# #                 self.create_slider(self.slider_layout, "Spatial frequency", 0, 10000, 500, 1)

# #             elif test_type == "Spatial Frequency":
# #                 self.create_slider(self.slider_layout, "Min Spatial Frequency", 0, 10000, 200, 1)
# #                 self.slider_layout.addSpacerItem(QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed))
# #                 self.create_slider(self.slider_layout, "Max Spatial Frequency", 0, 10000, 5000, 1)
# #                 self.slider_layout.addSpacerItem(QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed))
# #                 self.create_slider(self.slider_layout, "Contrast", 0, 1000, 1000, 1)

# #             elif test_type == "Vernier Acuity":
# #                 self.create_slider(self.slider_layout, "Min Phase", 0, 1000, 10, 1)
# #                 self.slider_layout.addSpacerItem(QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed))
# #                 self.create_slider(self.slider_layout, "Max Phase", 0, 1000, 1000, 1)
# #                 self.slider_layout.addSpacerItem(QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed))
# #                 self.create_slider(self.slider_layout, "Contrast", 0, 1000, 1000, 1)
# #                 self.slider_layout.addSpacerItem(QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed))
# #                 self.create_slider(self.slider_layout, "Spatial Frequency", 0, 10000, 1000, 1)

# #         elif experiment_type == "Staircase":
# #             if test_type == "Contrast Sensitivity":
# #                 self.create_slider(self.slider_layout, "Start Contrast", 0, 1000, 500, 1)
# #                 self.slider_layout.addSpacerItem(QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed))
# #                 self.create_slider(self.slider_layout, "Spatial frequency", 0, 10000, 500, 1)

# #             elif test_type == "Spatial Frequency":
# #                 self.create_slider(self.slider_layout, "Start Spatial Frequency", 0, 10000, 5000, 1)
# #                 self.slider_layout.addSpacerItem(QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed))
# #                 self.create_slider(self.slider_layout, "Contrast", 0, 1000, 1000, 1)

# #             elif test_type == "Vernier Acuity":
# #                 self.create_slider(self.slider_layout, "Start Phase", 0, 1000, 500, 1)
# #                 self.slider_layout.addSpacerItem(QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed))
# #                 self.create_slider(self.slider_layout, "Contrast", 0, 1000, 1000, 1)
# #                 self.slider_layout.addSpacerItem(QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed))
# #                 self.create_slider(self.slider_layout, "Spatial Frequency", 0, 10000, 1000, 1)
...
#         elif experiment_type == "Staircase":
#             self.create_slider(self.slider_layout, "Reversals", 0, 30, 12, 1)
#             self.slider_layout.addSpacerItem(QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed))
#             self.create_slider(self.slider_layout, "Down", 0, 1000, 100, 1)
#             self.slider_layout.addSpacerItem(QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed))
#             self.create_slider(self.slider_layout, "Up", 0, 1000, 200, 1)
#             self.slider_layout.addSpacerItem(QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed))
#             self.create_slider(self.slider_layout, "Step Size", 0, 1000, 100, 1)
...
#     panda_image_path = "panda6.png"  # Replace with your panda image path
#     experiment_type = "Fixed Increment"  # Example value, replace with your logic
...
class SetValuesWindow3(QMainWindow):
    ...
    def create_experiment_sliders(self, experiment_type, test_type):
        ...
        # elif experiment_type == "Staircase":
        #     if test_type == "Contrast Sensitivity":
        #         self.create_slider(self.slider_layout, "Start Contrast", 0, 1000, 10, 1)
        #         self.slider_layout.addSpacerItem(QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed))
        #         self.create_slider(self.slider_layout, "Spatial Frequency", 0, 10000, 500, 1)

        #     elif test_type == "Spatial Frequency":
        #         self.create_slider(self.slider_layout, "Start Spatial Frequency", 0, 1000, 10, 1)
        #         self.slider_layout.addSpacerItem(QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed))
        #         self.create_slider(self.slider_layout, "Contrast", 0, 1000, 1000, 1)

        #     elif test_type == "Vernier Acuity":
        #         self.create_slider(self.slider_layout, "Start Phase:", 0, 1000, 10, 1)
        #         self.slider_layout.addSpacerItem(QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed))
        #         self.create_slider(self.slider_layout, "Contrast", 0, 1000, 1000, 1)
        #         self.slider_layout.addSpacerItem(QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed))
        #         self.create_slider(self.slider_layout, "Spatial Frequency", 0, 10000, 1000, 1)
        ...
        if experiment_type == "Fixed Incrementor":
            ...
            if test_type == "Contrast Sensitivity":
                self.create_slider(self.slider_layout, "Start Contrast", 0, 1, 0.02, 0.001)
                self.slider_layout.addSpacerItem(QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed))
